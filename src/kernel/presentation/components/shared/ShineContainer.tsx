...
function ShineContainer({children ,classes}: MyComponentProps) {
    ...
    return (
        <div
            className={`group relative backdrop-blur-xl dark:bg-gray-400/10 bg-gray-400/5 border dark:border-gray-200/20 dark:hover:border-primary dark:hover:bg-primary/20 border-black/20 rounded-full shadow-lg py-1 px-1.5 overflow-hidden cursor-pointer text-xs ${classes}`}
        >
